...
# What is the name of this app?
	define('APP_NAME', 'Yusi');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'asadsaqib@fas.harvard.edu'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'lksjdfljsdflsjfsjfsfskdfjdskjfojslkfjdslkfjdslkjfsdlsdkfjsdlkjf');
	define('TOKEN_SALT', 'slkfjsdlkfjasdsanxmeusdhfhfuiihsfeskjhfiuehskjhfuehfskjdfhlsdkjfkl');